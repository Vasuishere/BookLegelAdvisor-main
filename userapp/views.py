...
from .models import user,contact,Attorneys,Client_Review,Blog,Types_Law,Practice_Area,case_categories,case_studies,Appointment,User_Appointment
...
def user_appo_intment(request):
    if request.POST:
        ...
        message = f"Hello This Is AutoGenerated Mail For Confirming Your Appointment Time : 10:30 AM"
